        ...
        <div className="lg:w-1/2 space-y-10 text-gray-900">
          ...
          <div className="space-y-4 text-gray-800 ">
            <p className="text-medium md:text-2xl">
              Our insulation solutions are designed to reduce heat loss by <span className="font-semibold">up to
              35%</span>, locking warmth inside the home and significantly lowering
              heating demand. Each property is assessed individually to maximise
              performance.
            </p>
            ...
            <p className="text-medium md:text-2xl">
              Each property is assessed individually to maximise
              performance.
            </p>
            ...
            <p className="text-medium md:text-2xl">
              Insulation is the invisible upgrade that makes everything work better.
            </p>
          </div>
        </div>
